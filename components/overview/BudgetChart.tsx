...
export default function BudgetChart({ budgets }: BudgetChartProps) {
  ...
  return (
    <div className="flex flex-col gap-space-250 md:flex-row xl:flex-row">
      ...
      <ul className="grid grid-cols-2 gap-space-200 md:ml-auto md:grid-cols-1 xl:grid-cols-1 xl:ml-auto">
